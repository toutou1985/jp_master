...
- (void)loadDataFromDB
{
    ...
    NSString * tql = [NSString stringWithFormat:@"select id,kanji,kana,chinese_means,right_num,wrong_num from word where mission_id=%@ and level_id=%@",self.mission_id,self.points];
